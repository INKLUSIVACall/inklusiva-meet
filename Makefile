...
source-package:
	...
	cp -r *.js *.html resources/*.txt inklusiva-call-favicon-32.png inklusiva-call-favicon-16.png fonts images libs static sounds LICENSE lang source_package/jitsi-meet && \
