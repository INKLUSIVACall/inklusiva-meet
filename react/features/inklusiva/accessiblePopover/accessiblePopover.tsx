...
import { getContextMenuStyle } from '../../base/popover/functions.web';
import { isElementInTheViewport } from '../../base/ui/functions.web';
import Drawer from '../../toolbox/components/web/Drawer';
import JitsiPortal from '../../toolbox/components/web/JitsiPortal';

import AccessibleDialogPortal from './accessibleDialogPortal';
...
/**
 * Abgeleitet von Popover, welches ein Portal erzeugt, was allerdings zu Accessibility-Problemen führt.
 * Deshalb wird hier eine eigene Komponente erstellt, die das Portal nicht mehr nutzt.
 *
 * @augments Component
 */
class accessiblePopover extends Component<IProps, IState> {
    /**
...
export default connect(_mapStateToProps)(accessiblePopover);
