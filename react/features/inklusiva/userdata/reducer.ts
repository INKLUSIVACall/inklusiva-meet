    ...
    (
        ...
        switch (action.type) {
            ...
            case SET_TRANSCRIPTION_ENABLED:
                nextState.assistant.transcription.active =
                    payload.transcriptionEnabled;
                return nextState;

            case SET_TRANSCRIPTION_FONTSIZE_VALUE:
                nextState.assistant.transcription.fontSize =
                    payload.fontSizeValue;
                return nextState;

            case SET_TRANSCRIPTION_HISTORY_VALUE:
                nextState.assistant.transcription.history =
            ...
            case SET_LEARNING_DIFFICULTIES_ENABLED:
                nextState.support.learning_difficulties =
                    payload.supportLearningDifficultiesEnabled;
                return nextState;

            case SET_SCREENREADER_ENABLED:
                nextState.ui.screenreaders = payload.supportScreenreaderEnabled;
                return nextState;
